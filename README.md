...
> This repository does not bundle fake “pets” made from static portraits. Kairo, Rook, Nebby, Byte, and Momo are completed installable v2 pets; the other built-in characters remain original planning concepts until their full animation atlases pass validation.

## Ready-to-install pets

| Kairo | Rook | Nebby | Byte | Momo |
| --- | --- | --- | --- | --- |
| <img src="./pets/kairo/preview.gif" alt="Kairo animated preview" width="180"> | <img src="./pets/rook/preview.gif" alt="Rook animated preview" width="180"> | <img src="./pets/nebby/preview.gif" alt="Nebby animated preview" width="180"> | <img src="./pets/byte/preview.gif" alt="Byte animated preview" width="180"> | <img src="./pets/momo/preview.gif" alt="Momo animated preview" width="180"> |
| Cosmic energy fighter · 73 frames | Red-haired court ace · 73 frames | Quiet cosmic cat · 73 frames | Curious code bot · 73 frames | Cheerful candy fox · 73 frames |
| [Download ZIP](https://github.com/CosmicCoderDev/codex-pet-lab/releases/download/v0.7.0/codex-pet-kairo-v2.zip) | [Download ZIP](https://github.com/CosmicCoderDev/codex-pet-lab/releases/download/v0.7.0/codex-pet-rook-v2.zip) | [Download ZIP](https://github.com/CosmicCoderDev/codex-pet-lab/releases/download/v0.7.0/codex-pet-nebby-v2.zip) | [Download ZIP](https://github.com/CosmicCoderDev/codex-pet-lab/releases/download/v0.7.0/codex-pet-byte-v2.zip) | [Download ZIP](https://github.com/CosmicCoderDev/codex-pet-lab/releases/download/v0.7.0/codex-pet-momo-v2.zip) |

[Open the live studio](https://cosmiccoderdev.github.io/codex-pet-lab/) · [Download v0.7.0](https://github.com/CosmicCoderDev/codex-pet-lab/releases/tag/v0.7.0)
...
- Bundled Kairo, Rook, Nebby, Byte, and Momo v2 packages, each with 73 animated frames: nine standard states plus 16 look directions
...
List and install any bundled pet directly from this repository:
...
Alternatively, download a ZIP from the [v0.7.0 release](https://github.com/CosmicCoderDev/codex-pet-lab/releases/tag/v0.7.0), extract it, and pass the extracted folder through `-SourceDir`.
