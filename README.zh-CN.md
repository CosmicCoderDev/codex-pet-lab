...
| Kairo | Rook |
| --- | --- |
| <img src="./pets/kairo/preview.gif" alt="Kairo 动画预览" width="180"> | <img src="./pets/rook/preview.gif" alt="Rook 动画预览" width="180"> |
| 宇宙能量战士 · 73 帧 | 红发球场王牌 · 73 帧 |
| [下载 ZIP](https://github.com/CosmicCoderDev/codex-pet-lab/releases/download/v0.4.0/codex-pet-kairo-v2.zip) | [下载 ZIP](https://github.com/CosmicCoderDev/codex-pet-lab/releases/download/v0.4.0/codex-pet-rook-v2.zip) |

[打开在线工作室](https://cosmiccoderdev.github.io/codex-pet-lab/) · [下载 v0.4.0](https://github.com/CosmicCoderDev/codex-pet-lab/releases/tag/v0.4.0)
...
也可以从 [v0.4.0 Release](https://github.com/CosmicCoderDev/codex-pet-lab/releases/tag/v0.4.0) 下载 ZIP，解压后通过 `-SourceDir` 安装。
