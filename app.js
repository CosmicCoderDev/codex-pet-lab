...
const translations = {
  en: {
    ...
    "concepts.note": "Fourteen original directions, including five complete installable v2 pets. They borrow broad anime energy, never protected names, costumes, or character likenesses.",
  ...
  zh: {
    ...
    "concepts.note": "共 14 个原创人物方向，其中五个已完成为可安装 v2 宠物；只借鉴宽泛的动漫气质，不复制受保护的姓名、服装或角色形象。",
