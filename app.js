...
const translations = {
  en: {
    ...
    "concepts.note": "Fourteen original directions, including nine complete installable v2 pets. They borrow broad anime energy, never protected names, costumes, or character likenesses.",
  ...
  zh: {
    ...
    "concepts.note": "共 14 个原创人物方向，其中九个已完成为可安装 v2 宠物；只借鉴宽泛的动漫气质，不复制受保护的姓名、服装或角色形象。",
...
const concepts = {
  ...
  shino: { name: "Shino", id: "shino", category: "ninja", color: "#49405f", image: "./pets/shino/preview.gif", bundledPack: "./pets/shino/spritesheet.webp", description: "A quiet shadow runner for stealthy refactors.", zhDescription: "擅长安静完成重构的暗影忍者。" },
  aster: { name: "Aster", id: "aster", category: "fantasy", color: "#3d7794", image: "./pets/aster/preview.gif", bundledPack: "./pets/aster/spritesheet.webp", description: "A frost guardian who cools down hot code paths.", zhDescription: "为高温代码路径降温的寒霜守护者。" },
  nova: { name: "Nova", id: "nova", category: "scifi", color: "#8c4f98", image: "./pets/nova/preview.gif", bundledPack: "./pets/nova/spritesheet.webp", description: "A neon mech pilot ready for high-risk deployments.", zhDescription: "随时准备执行高风险部署的霓虹机甲驾驶员。" },
